...
public class OverlayShowRoute extends ItemizedOverlay<OverlayItem> {
	...
	protected boolean onTap(int i) {
		 ...
		 * overlay item. In a more serious application one could replace the
		 * Toast with display of a customized view with the title, snippet text,
		 * and additional features like an embedded image, video, or sound, or
		 * links to additional information. (The lat and lon variables return
		 * the coordinates of the icon that was clicked, which could be used for
		 * custom positioning of a display view.)
		 */
