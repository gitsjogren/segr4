		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view,
				...
				case 0: // Start J.A. Pripps activity
					Intent jaPripps = new Intent(getApplicationContext(),
							PubLayout.class);
				...
				case 1: // Start Gasquen activity
					Intent gasquen = new Intent(getApplicationContext(),
							PubLayout.class);
				...
				case 2: // Start Bulten activity
					Intent bulten = new Intent(getApplicationContext(),
							PubLayout.class);
				...
				case 3: // Start Winden activity
					Intent winden = new Intent(getApplicationContext(),
							PubLayout.class);
				...
				case 4: // Start Zaloonen Pripps activity
					Intent zaloonen = new Intent(getApplicationContext(),
							PubLayout.class);
				...
				case 5: // Start Club Avancez activity
					Intent clubAvancez = new Intent(getApplicationContext(),
							PubLayout.class);
				...
				case 6: // Start GoldenI activity
					Intent goldenI = new Intent(getApplicationContext(),
							PubLayout.class);
				...
				case 7: // Start Hubben 2.1 activity
					Intent hubben = new Intent(getApplicationContext(),
							PubLayout.class);
				...
				case 8: // Start Basen activity
					Intent basen = new Intent(getApplicationContext(),
							PubLayout.class);
				...
				case 9: // Start Kajsabaren activity
					Intent kajsaBaren = new Intent(getApplicationContext(),
							PubLayout.class);
				...
				case 10: // Start Järnvägspub activity
					Intent jarnvagsPub = new Intent(getApplicationContext(),
							PubLayout.class);
				...
				case 11: // Start GasTown activity
					Intent gasTown = new Intent(getApplicationContext(),
							PubLayout.class);
				...
				case 12: // Start FortNOx activity
					Intent fortNox = new Intent(getApplicationContext(),
							PubLayout.class);
				...
				case 13: // Start Spritköket activity
					Intent spritkoket = new Intent(getApplicationContext(),
							PubLayout.class);
				...
				case 14: // Start Focus activity
					Intent focus = new Intent(getApplicationContext(),
							PubLayout.class);
				...
				case 15: // Start Röda rummet activity
					Intent rodaRummet = new Intent(getApplicationContext(),
							PubLayout.class);
				...
				case 16: // Start Sigurd/A-fiket activity
					Intent sigurdAfiket = new Intent(getApplicationContext(),
							PubLayout.class);
				...
				case 17: // Start Pub P activity
					Intent pubP = new Intent(getApplicationContext(),
							PubLayout.class);
				...
				case 18: // Start Pub F activity
					Intent pubF = new Intent(getApplicationContext(),
							PubLayout.class);
