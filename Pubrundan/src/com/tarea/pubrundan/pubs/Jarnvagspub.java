...
public class Jarnvagspub extends PubLayout {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		super.onCreate(savedInstanceState, R.layout.jarnvagspub);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		return super.onOptionsItemSelected(item, "Järnvägspub", R.string.ja_pripps_info, 10);
	}
