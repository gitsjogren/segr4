...
public class Winden extends PubLayout {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		super.onCreate(savedInstanceState, R.layout.winden);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		return super.onOptionsItemSelected(item, "Winden", R.string.ja_pripps_info, 3);
	}
