...
public class GoldenI extends PubLayout {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		super.onCreate(savedInstanceState, R.layout.goldeni);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		return super.onOptionsItemSelected(item, "GoldenI", R.string.ja_pripps_info, 6);
	}
