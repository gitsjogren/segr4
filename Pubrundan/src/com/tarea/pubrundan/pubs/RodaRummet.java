...
public class RodaRummet extends PubLayout {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		super.onCreate(savedInstanceState, R.layout.rodarummet);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		return super.onOptionsItemSelected(item, "Röda rummet", R.string.ja_pripps_info, 15);
	}
