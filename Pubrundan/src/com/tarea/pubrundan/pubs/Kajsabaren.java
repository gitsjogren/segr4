...
public class Kajsabaren extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
			...
			requestWindowFeature(Window.FEATURE_NO_TITLE); // Suppress title bar for
															// more space
			setContentView(R.layout.kajsabaren);
