...
public class SigurdAfiket extends PubLayout {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		super.onCreate(savedInstanceState, R.layout.sigurdafiket);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		return super.onOptionsItemSelected(item, "Sigurd/A-fiket", R.string.ja_pripps_info, 16);
	}
